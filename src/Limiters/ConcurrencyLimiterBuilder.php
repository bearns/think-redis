...
namespace Bearns\Redis\Limiters;

use Bearns\Redis\HasInteractsWithTime;
use Bearns\Redis\Exceptions\LimiterTimeoutException;

class ConcurrencyLimiterBuilder
{
    use HasInteractsWithTime;

    /**
     * The Redis connection.
     *
     * @var \Bearns\Redis\Connections\Connection
     */
    public $connection;
     ...
     *
     * @param  \Bearns\Redis\Connections\Connection $connection
     * @param  string $name
     * @return void
     */
     ...
     * @return mixed
     *
     * @throws \Bearns\Redis\Exceptions\LimiterTimeoutException
     */
